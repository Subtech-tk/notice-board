...
//	this page is designed to recover the user password using usn and dob as password
// 	not compatiable with firefox brower

  $page_name="password_recovery.php";

  $title="Password_recovery";
  
  $keywords="Password_recovery";
